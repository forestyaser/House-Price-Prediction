...
class Show_Accuracy():
    ...
    def show(self):
        # result_file = "/var/qindom/realmaster/csv_file/xgb_result.csv"
        if self.result_file:
            df_result = pd.read_csv(self.result_file, usecols=['_id', 'Sp', 'Pp'])
        else:
            df_result = self.result_df
            df_result = df_result[['_id', 'Sp', 'Pp']]
        ...
        print("within_3_percent: " + '%.2f%%' % (within_3_percent * 100) + ' with median: ' + '%.2f%%' % (
                median_within_3_percent * 100))
        print('within_5_percent: ' + '%.2f%%' % (within_5_percent * 100) + ' with median: ' + '%.2f%%' % (
                median_within_5_percent * 100))
        print('within_10_percent: ' + '%.2f%%' % (within_10_percent * 100) + ' with median: ' + '%.2f%%' % (
                median_within_10_percent * 100))
        print('within_20_percent: ' + '%.2f%%' % (within_20_percent * 100) + ' with median: ' + '%.2f%%' % (
                median_within_20_percent * 100))
