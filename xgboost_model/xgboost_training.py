...
from RealMasterService.src.main.xgboost_model import xgb_mapper
from sklearn.model_selection import RandomizedSearchCV
from RealMasterService.src.main.config import RealMasterServiceConfig, constants
import pickle
import os
import pandas as pd
import numpy as np
from RealMasterService.src.main.utils.utils import remove_local_file
from RealMasterService.src.main.cnn_model.show_accuracy import Show_Accuracy
...
def predict_xgb_and_show_accuracy(df_test, xgb_model_path):
    ...
    accuracy.show()
    # df_output.to_csv(RealMasterServiceConfig.RESULT_PATH + 'xgb_result_0611.csv', index=False)
    # print(df_output)
    return results_arr


if __name__ == "__main__":
    model_path = RealMasterServiceConfig.MODEL_PATH + 'xgb_model_gpu.pkl'
    '''
    Train
    '''
    data_file = RealMasterServiceConfig.DATA_PATH + 'toronto_house_data.csv'
    ...
    Test
    '''
    # test_file = RealMasterServiceConfig.DATA_PATH + 'toronto_test_file.csv'
    # generate_predict_file(test_file, model_path)

    '''
    Validate
    '''
    # result_file = RealMasterServiceConfig.RESULT_PATH + 'xgb_result_0611.csv'
